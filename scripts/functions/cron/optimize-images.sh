...
do
  echo "Optimizing images for ${i}. This will take a while..."
	...
	/usr/local/bin/zimageoptimizer/zImageOptimizer.sh -p /var/www/sites/$i/html/wp-content/uploads -n -q -m /home/EngineScript/zImageOptimizer-time-marker/time-marker
