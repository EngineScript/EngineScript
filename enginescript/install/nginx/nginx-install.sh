...
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-create-directories.sh

# Custom Nginx Error Pages
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-error-pages.sh

# Misc Nginx Stuff
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-misc.sh

# Backup Nginx
/usr/local/bin/enginescript/enginescript/cron/nginx-backup.sh

# Cloudflare
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-cloudflare.sh

# SSL
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-ssl.sh

# Assign Admin Password
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-admin-password.sh

# Install Nginx Service
/usr/local/bin/enginescript/enginescript/install/nginx/nginx-service.sh
