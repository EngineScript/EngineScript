...
import { DashboardAPI } from './modules/api.js?v=2025.11.21.05';
import { DashboardState } from './modules/state.js?v=2025.11.21.05';
import { DashboardCharts } from './modules/charts.js?v=2025.11.21.05';
  ...
  async loadExternalServices() {
    try {
      ...
      // Dynamic import - only loads when needed
            const { ExternalServicesManager } = await import('./external-services/external-services.js?v=2025.11.21.05');
